...
go
insert into filetypes(name) values('Í¼Æ¬');
insert into filetypes(name) values('ÎÄµµ');
insert into filetypes(name) values('ÊÓÆµ');
insert into filetypes(name) values('ÒôÀÖ');
insert into filetypes(name) values('Ñ¹Ëõ°ü');
insert into filetypes(name) values('ÆäËü');
go
